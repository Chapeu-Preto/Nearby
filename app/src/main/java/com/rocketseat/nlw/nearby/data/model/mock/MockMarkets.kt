...
val mockMarkets = listOf(
    Market(
        ...
        //    Rule(id = "2", description = "Disponível apenas para consumo no local", marketId = "012576ea-4441-4b8a-89e5-d5f32104c7c4")
        //),
    ...
    Market(
        ...
        categoryId = "146b1a88-b3d3-4232-8b8f-c1f006f1e86d",
        name = "Café Central",
        description = "Cafeteria aconchegante com opções de lanches e bebidas artesanais.",
        coupons = 10,
        //rules = emptyList(),
        ...
        phone = "(12) 3456-7890",
        cover = "https://images.unsplash.com/photo-1551218808-994e220e084d2?w=400&h=300"
    )
)